...
def main_attack_surrogate_for_victim_clf(experiment: str, ds_local_path: str, device: str,
                                         batch_size: int, epsilons: list, net_surrogate_local_dir: str,
                                         net_victim_local_dir: str, attack: str = 'fgsm'):
    print('-' * NUM_OF_HYPHENS)
    print('Running attack surrogate for victim clf experiment...')
    ...
    print('attack train')
    results_deep_df = attack_clf(experiment=experiment,
                                 device=device,
                                 attack=attack,
    ...
    print('Finished running attack surrogate for victim clf experiment!')
