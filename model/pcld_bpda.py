...
class CLD(nn.Module):
    """
    Classifier-Decisioner (CLD) architecture.

    This module takes input data  processes each step through a shared classifier, and then aggregates the
    resulting probability distributions through a 'decisioner' network to produce
    a final output.
    """

    def __init__(self, clf: torch.nn.Module, decisioner: torch.nn.Module, num_paint_steps: int,
                 decisioner_architecture: str = 'conv'):
